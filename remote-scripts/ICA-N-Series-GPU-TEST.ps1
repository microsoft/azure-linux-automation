...
"@
		...
		RemoteCopy -uploadTo $clientVMData.PublicIP -port $clientVMData.SSHPort -files ".\$constantsFile,.\remote-scripts\azuremodules.sh,.\remote-scripts\GPU_Test.sh,.\$LogDir\$StartScriptName" -username "root" -password $password -upload
